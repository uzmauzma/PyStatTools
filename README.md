...
<p1>The Survey Analysis Tool is a Python-based application designed for performing various statistical analyses,
  ...
  to upload survey datasets, choose analysis types, select variables, and visualize results.

The tool is developed to cater to researchers and data analysts who may not have extensive programming
